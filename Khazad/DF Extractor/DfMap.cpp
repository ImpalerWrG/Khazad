...
bool DfMap::isOpenTerrain(int in)
{
    switch (in)
    {
...
bool DfMap::isFloorTerrain(int in)
{
    switch (in)
    {
        case 2:   //murky pool
...
bool DfMap::isRampTerrain(int in)
{
    switch (in)
    {
        case 233: //ramp grass dry
...
bool DfMap::isStairTerrain(int in)
{
    switch (in)
    {
        case 25: //up-down stair frozen liquid
