...
SplashScreen::SplashScreen(GUI* TargetGuiManager)
{
    GuiManager = TargetGuiManager;
}
...
bool SplashScreen::Init()
{
    ...
    PanelWidgit = GuiManager->getGUI()->createWidget<MyGUI::Widget>("Button", MyGUI::IntCoord((view.width - 200) / 2, (view.height - 100) * 2 / 3, 200, 100), MyGUI::Align::HCenter, "Main");
    ...
    LogoImage = GuiManager->getGUI()->createWidget<MyGUI::StaticImage>("StaticImage", MyGUI::IntCoord((view.width - size.width) / 2, (view.height - size.height) / 4, size.width, size.height), MyGUI::Align::Default, "Main");
