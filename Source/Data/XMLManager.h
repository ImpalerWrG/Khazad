...
public:
    ...
    bool QueryTextValue(TiXmlElement* Entry, const char* Element, const char* Attribute, std::string& String)
    {
        TiXmlElement* child = Entry->FirstChildElement(Element);
        if (child)
        {
    ...
    void QueryTextArray(TiXmlElement* Entry, const char* Element, const char* SubElement, const char* Attribute, std::vector<std::string>* StorageVector)
    {
        TiXmlElement* child = Entry->FirstChildElement(Element);
        if (child)
        {
